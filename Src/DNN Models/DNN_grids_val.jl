...
include("C:/Zinebjl/function/grid_search_dnn.jl")
...
best_hyperparameters,best_score=grid_search_dnn(Xtrainst, ytrain)
...
data=DataLoader((Xtrainst',ytrain), batchsize = best_hyperparameters[2],shuffle=false);

# Initialize the optimizer
opt = Adam(best_hyperparameters[3])
param = params(model) 
